...
public class Meterinfo extends JFrame implements ActionListener {
    ...
    JButton next;
    JLabel lblname, lblmeternumber, lblmeterno, lbladdress, lblcity, lblstate, lblphone, lblemail, lblemails, lblphones;
    ...
    Meterinfo(String meternumber) {
        ...
        lblphones = new JLabel("By Default Bill is calculated for 30 days only");
