...
public class CalculateBill extends JFrame implements ActionListener {
    ...
    JButton next, cancel;
    JLabel  lblname, lbladdress, lblcity, lblstate, lblphone, lblemail, lblmeternumber;
    ...
    CalculateBill() {
        ...
        try {
           conn c = new conn();
           java.sql.ResultSet rs = c.s.executeQuery("select * from customer where meter_no = '"+meternumber.getSelectedItem()+"'");
           while(rs.next()) {
