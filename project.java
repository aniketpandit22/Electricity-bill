...
public class project extends JFrame implements ActionListener{
    ...
    project(String atype, String meter) {
      ...
      billdetails.setIcon(new ImageIcon(image8));
       billdetails.setMnemonic('J');
       billdetails.addActionListener(this);
       billdetails.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_J, ActionEvent.CTRL_MASK));
        ...
        generatebill.setMnemonic('K');
        generatebill.addActionListener(this);
       generatebill.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_K, ActionEvent.CTRL_MASK));
       ...
       calculator.setBackground(Color.WHITE);
        ...
        calculator.setMnemonic('F');
         calculator.addActionListener(this);
       calculator.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F, ActionEvent.CTRL_MASK));
